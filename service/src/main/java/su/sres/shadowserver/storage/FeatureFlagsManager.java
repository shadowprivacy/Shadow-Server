...
/**
 * The feature flags manager provides a high-throughput, eventually-consistent
 * view of feature flags. This is the main channel through which callers should
 * interact with feature flags.
 * <p/>
 * Feature flags are intended to provide temporary control over server-side
 * features (i.e. for migrations or experiments with new services). Each flag is
 * identified by a human-readable name (e.g. "invert-nano-flappers") and is
 * either active or inactive. Flags (including flags that have not been set) are
 * inactive by default.
 */
