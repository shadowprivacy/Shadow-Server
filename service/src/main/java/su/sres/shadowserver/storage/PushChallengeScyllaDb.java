 ...
 */
public class PushChallengeScyllaDb extends AbstractScyllaDbStore {
  ...
  public PushChallengeScyllaDb(final DynamoDbClient dynamoDB, final String tableName) {
    this(dynamoDB, tableName, Clock.systemUTC());
  }

  @VisibleForTesting
  PushChallengeScyllaDb(final DynamoDbClient dynamoDB, final String tableName, final Clock clock) {
    super(dynamoDB);
