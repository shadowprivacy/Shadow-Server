...
public class RemoteConfigsTest {
	...
	public void testStore() {
		remoteConfigs.set(new RemoteConfig("android.stickers", 50,
				Set.of(AuthHelper.VALID_UUID, AuthHelper.VALID_UUID_TWO), "FALSE", "TRUE"));
		remoteConfigs
				.set(new RemoteConfig("value.sometimes", 25, Set.of(AuthHelper.VALID_UUID_TWO), "default", "custom"));
