...
import su.sres.shadowserver.groups.protos.GroupChange.Actions.ModifyAvatarAction;
import su.sres.shadowserver.groups.protos.GroupChange.Actions.ModifyTitleAction;
...
public class GroupsControllerTest extends BaseGroupsControllerTest {
  ...
  public void testCreateGroupConflict() {
    ...
    ProfileKeyCredentialPresentation presentation = new ClientZkProfileOperations(GroupAuthHelper.GROUPS_SERVER_KEY.getPublicParams()).createProfileKeyCredentialPresentation(groupSecretParams, GroupAuthHelper.VALID_USER_PROFILE_CREDENTIAL);
  ...
  public void testGetGroupJoinInfo() throws Exception {
    ...
    Response response = resources.getJerseyTest()
                                 ...
                                 .request(ProtocolBufferMediaType.APPLICATION_PROTOBUF)
                                 .header("Authorization", GroupAuthHelper.getAuthHeader(groupSecretParams, GroupAuthHelper.VALID_USER_THREE_AUTH_CREDENTIAL))
                                 .get();
  ...
  public void testModifyMemberPresentation() throws Exception {
    ...
    ProfileKeyCredentialPresentation validUserPresentation          = new ClientZkProfileOperations(GroupAuthHelper.GROUPS_SERVER_KEY.getPublicParams()).createProfileKeyCredentialPresentation(groupSecretParams, GroupAuthHelper.VALID_USER_PROFILE_CREDENTIAL    );
    ProfileKeyCredentialPresentation validUserTwoPresentation       = new ClientZkProfileOperations(GroupAuthHelper.GROUPS_SERVER_KEY.getPublicParams()).createProfileKeyCredentialPresentation(groupSecretParams, GroupAuthHelper.VALID_USER_TWO_PROFILE_CREDENTIAL);
    ProfileKeyCredentialPresentation validUserTwoPresentationUpdate = new ClientZkProfileOperations(GroupAuthHelper.GROUPS_SERVER_KEY.getPublicParams()).createProfileKeyCredentialPresentation(groupSecretParams, GroupAuthHelper.VALID_USER_TWO_PROFILE_CREDENTIAL);
  ...
  public void testDeleteMemberPendingProfileKeyUnauthorized() {
    ...
    ProfileKeyCredentialPresentation validUserPresentation      = new ClientZkProfileOperations(GroupAuthHelper.GROUPS_SERVER_KEY.getPublicParams()).createProfileKeyCredentialPresentation(groupSecretParams, GroupAuthHelper.VALID_USER_PROFILE_CREDENTIAL      );
    ProfileKeyCredentialPresentation validUserTwoPresentation   = new ClientZkProfileOperations(GroupAuthHelper.GROUPS_SERVER_KEY.getPublicParams()).createProfileKeyCredentialPresentation(groupSecretParams, GroupAuthHelper.VALID_USER_TWO_PROFILE_CREDENTIAL  );
    ProfileKeyCredentialPresentation validUserThreePresentation = new ClientZkProfileOperations(GroupAuthHelper.GROUPS_SERVER_KEY.getPublicParams()).createProfileKeyCredentialPresentation(groupSecretParams, GroupAuthHelper.VALID_USER_THREE_PROFILE_CREDENTIAL);
  ...
  public void testGetGroupLogsTooManyTest() throws Exception {
    ...
    when(groupsManager.getChangeRecords(eq(ByteString.copyFrom(groupPublicParams.getGroupIdentifier().serialize())), eq(group), eq(6), eq(70)))
        .thenReturn(expectedChanges.subList(0, 64));
  ...
  public void testGetGroupLogsTooOldTest() {
    ...
    ProfileKeyCredentialPresentation validUserPresentation    = new ClientZkProfileOperations(GroupAuthHelper.GROUPS_SERVER_KEY.getPublicParams()).createProfileKeyCredentialPresentation(groupSecretParams, GroupAuthHelper.
