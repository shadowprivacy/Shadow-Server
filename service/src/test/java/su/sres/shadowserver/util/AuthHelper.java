...
public class AuthHelper {
	...
	when(VALID_ACCOUNT.getUserLogin()).thenReturn(VALID_NUMBER);
	when(VALID_ACCOUNT.getUuid()).thenReturn(VALID_UUID);
	when(VALID_ACCOUNT_TWO.getUserLogin()).thenReturn(VALID_NUMBER_TWO);
	...
	when(VALID_ACCOUNT.isDiscoverableByUserLogin()).thenReturn(true);
	when(VALID_ACCOUNT_TWO.isDiscoverableByUserLogin()).thenReturn(true);
	when(DISABLED_ACCOUNT.isDiscoverableByUserLogin()).thenReturn(true);
